...
Material design icons is the official [icon set](https://material.io/resources/icons/) from Google.  The icons are designed under the [material design guidelines](https://material.io/guidelines/).
